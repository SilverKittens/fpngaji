  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Hompage</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url() ?>Admin"><i class="fa fa-circle-o"></i> Dashboard Admin</a></li>
          </ul>
        </li>
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url() ?>Admin/guru"><i class="fa fa-circle-o"></i> Guru</a></li>
            <li><a href="<?php echo base_url() ?>Admin/jadwal"><i class="fa fa-circle-o"></i>Jadwal</a></li>
          </ul>
        </li>

        <li><a href="<?php echo base_url()?>/logout"><i class="fa fa-book"></i> <span>Log Out</span></a></li>
                ...
                <table>
                  <thead>
                    <tr class="row100 head">
                      ...
                      <th class="cell100 column3">Berkas</th>
